...
class Version(object):
    ...
    def __init__(self, package, major, minor, micro, release_candidate=None,
        ...
        if major == "NEXT" and (minor or micro or release_candidate or dev):
    ...
    def public(self):
        ...
        dev = "" if self.dev is None else "dev%s" % (self.dev,)
    ...
    def __repr__(self):
        ...
        dev = "" if self.dev is None else ", dev=%r" % (self.dev,)
    ...
    def __cmp__(self, other):
        ...
        major = _inf if self.major == "NEXT" else self.major
        if self.release_candidate is None:
            release_candidate = _inf
        else:
            release_candidate = self.release_candidate

        dev = _inf if self.dev is None else self.dev
        othermajor = _inf if other.major == "NEXT" else other.major
        otherrc = _inf if other.release_candidate is None else other.release_candidate
        otherdev = _inf if other.dev is None else other.dev
        return _cmp((major,
                      self.minor,
                      self.micro,
                      release_candidate,
